...
export default function PWAInstall() {
  ...
  return (
    <div style={{
      ...
      zIndex: 9999, width: 'calc(100vw - 2rem)', maxWidth: 420,
      background: 'linear-gradient(135deg, #0A1628, #060B14)',
      border: '1px solid rgba(0,255,178,0.3)', borderRadius: 14,
      ...
      <div style={{ padding: '1rem 1.1rem' }}>
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ fontFamily: HUD, fontSize: 11, fontWeight: 900, color: '#E8F4F8', letterSpacing: 0.5, marginBottom: 3 }}>{c.title}</div>

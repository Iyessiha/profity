...
const PLANS = [
  ...
  },
  {
    ...
    perks: [
      ...
      { icon: 'ti-robot',         text: 'EA Tracker MT5 inclus — suivi challenge temps réel' },
      { icon: 'ti-dashboard',     text: 'Dashboard challenge Prop Firm (profit, DD, jours)' },
      { icon: 'ti-shield-check',  text: 'Alertes automatiques avant breach de règles' },
    ],
    missing: [],
  },
  {
    ...
    perks: [
      ...
      { icon: 'ti-robot',        text: 'Robot MT5 inclus — Trend-Follow + Prop Firm Guard auto' },
      { icon: 'ti-shield-lock',  text: 'Guard adaptatif : lot réduit si DD s\'approche limite' },
      { icon: 'ti-target-arrow', text: 'Stop automatique quand objectif de challenge atteint' },
      { icon: 'ti-activity',     text: 'Dashboard challenge avancé + courbe d\'equity live' },
    ],
    missing: [],
  },
]
...
const FAQS = [
  ...
  { q: 'C\'est quoi le suivi challenge Prop Firm ?', r: 'Disponible en PRO et ELITE. Tu connectes ton compte MT5 via un EA (Expert Advisor) gratuit fourni. Le Dashboard ProfityX suit en temps réel ta balance, ton equity, ton drawdown journalier/total et tes jours de trading. Tu reçois une alerte avant tout breach de règles.' },
  { q: 'L\'EA Tracker trade-t-il automatiquement ?', r: 'Non. L\'EA Tracker (inclus en PRO) ne passe aucun ordre. Il surveille uniquement ton compte et envoie les données à ProfityX. Tu gardes le contrôle total de tes trades.' },
  { q: 'Et le Robot MT5 (plan ELITE) ?',      r: 'Le Robot MT5 est un Expert Advisor de trading automatique basé sur une stratégie Trend-Follow (EMA 50/200 + Stochastique). Il intègre un Prop Firm Guard : position sizing adaptatif, suspension automatique si le DD approche les limites, et arrêt quand l\'objectif est atteint. Résultats non garantis — backtestate toujours avant de l\'utiliser sur un vrai challenge.' },
  { q: 'Le Robot garantit-il de passer un challenge ?', r: 'Non, et méfie-toi de quiconque garantit ça. Le Robot est un outil de discipline — il applique des règles de risk management strictes pour éviter les erreurs humaines. Ses performances dépendent des conditions de marché. Teste toujours sur compte démo d\'abord.' },

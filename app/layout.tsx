...
export const metadata: Metadata = {
  ...
  openGraph: {
    images: [{ url: '/logos/profityx-logo.png', width: 800, height: 800 }], title: 'ProfityX — Trading IA', description: 'Signaux de trading propulsés par l\'IA', type: 'website', locale: 'fr_FR' },
}

...
const PAIRS = [
  ...
  // Indices Deriv Synthétiques
  { label:'Boom 1000',     group:'Deriv', pipSize:0.001, pipValuePerLot:1,    contractSize:1     },
  { label:'Boom 500',      group:'Deriv', pipSize:0.001, pipValuePerLot:1,    contractSize:1     },
  { label:'Crash 1000',    group:'Deriv', pipSize:0.001, pipValuePerLot:1,    contractSize:1     },
  { label:'Crash 500',     group:'Deriv', pipSize:0.001, pipValuePerLot:1,    contractSize:1     },
  { label:'Volatility 75', group:'Deriv', pipSize:0.001, pipValuePerLot:1,    contractSize:1     },
  { label:'Volatility 25', group:'Deriv', pipSize:0.001, pipValuePerLot:1,    contractSize:1     },
  { label:'Volatility 10', group:'Deriv', pipSize:0.001, pipValuePerLot:1,    contractSize:1     },
  { label:'Step Index',    group:'Deriv', pipSize:0.001, pipValuePerLot:1,    contractSize:1     },
  // Crypto

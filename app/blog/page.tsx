  ...
  return (
    <div style={{ minHeight:'100vh', background:'#020408', color:'#F0F8FF', fontFamily:BODY }}>
      ...
      <footer style={{ borderTop:'1px solid rgba(255,255,255,0.05)', padding:'2rem', textAlign:'center' }}>
        <Link href="/" style={{ fontFamily:HUD, fontSize:12, letterSpacing:2, color:'#00FFB2', textDecoration:'none' }}><img src="/logos/profityx-logo.png" alt="ProfityX" style={{ height:28, width:'auto', objectFit:'contain' }} /></Link>

...
const ASSET_MAP: Record<string, { symbol: string; label: string; broker?: string }[]> = {
  ...
  synthetic:   [
    { symbol:'Boom 1000',    label:'BOOM 1000',   broker:'Indices Synthétiques'},
    { symbol:'Boom 500',     label:'BOOM 500',    broker:'Indices Synthétiques'},
    { symbol:'Crash 1000',   label:'CRASH 1000',  broker:'Indices Synthétiques'},
    { symbol:'Crash 500',    label:'CRASH 500',   broker:'Indices Synthétiques'},
    { symbol:'Volatility 75',label:'VOL 75',      broker:'Indices Synthétiques'},
    { symbol:'Volatility 50',label:'VOL 50',      broker:'Indices Synthétiques'},
    { symbol:'Volatility 25',label:'VOL 25',      broker:'Indices Synthétiques'},
    { symbol:'Volatility 100',label:'VOL 100',    broker:'Indices Synthétiques'},
    { symbol:'Step Index',   label:'STEP',        broker:'Indices Synthétiques'},
    { symbol:'GainX 600',    label:'GainX 600',   broker:'Indices Synthétiques'},
    { symbol:'GainX 1000',   label:'GainX 1000',  broker:'Indices Synthétiques'},
    { symbol:'LossX 600',    label:'LossX 600',   broker:'Indices Synthétiques'},
    { symbol:'LossX 1000',   label:'LossX 1000',  broker:'Indices Synthétiques'},
    { symbol:'Jump 75',      label:'JUMP 75',     broker:'Indices Synthétiques'},
    { symbol:'Jump 100',     label:'JUMP 100',    broker:'Indices Synthétiques'},
    { symbol:'Range Break 100',label:'RANGE BR',  broker:'Indices Synthétiques'},
  ],
